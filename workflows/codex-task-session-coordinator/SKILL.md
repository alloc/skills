...
- Performed validation and provided the results.
...
2. If the rebase succeeds, run the task's relevant post-rebase validation when its readiness report identifies a focused command. Do not review or modify the implementation.
