...
Source: https://react-aria.adobe.com/useDraggableCollectionState.html

## Import

- Package: `react-stately`
- Import: `import {useDraggableCollectionState} from 'react-stately'`
...
```ts
useDraggableCollectionState<T = object>(props: DraggableCollectionStateOptions<T>): DraggableCollectionState
```
