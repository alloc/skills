...
- Package: `react-aria`
- Import: `import {useGridListItem} from 'react-aria'`
...
- [useGridListSelectionCheckbox](./use-grid-list-selection-checkbox.md)
