...
Source: https://react-aria.adobe.com/DateRangePicker/useDateRangePicker.html

## Import

- Package: `react-aria`
- Import: `import {useDateRangePicker} from 'react-aria'`
...
```ts
useDateRangePicker<T extends DateValue>(props: AriaDateRangePickerProps<T>, state: DateRangePickerState, ref: RefObject<Element | null>): DateRangePickerAria
```
