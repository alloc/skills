...
- Package: `react-aria`
- Import: `import {useSlider} from 'react-aria'`
...
```ts
useSlider<T extends number | number[]>(props: AriaSliderProps<T>, state: SliderState, trackRef: RefObject<Element | null>): SliderAria
```
...
- [useSliderThumb](./use-slider-thumb.md)
