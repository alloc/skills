...
* Make it easy for the human to answer with "yes," "no," "next," or a small correction.
...
* Bold the substantive answer text, not just the label.
...
* For yes/no decisions, start suggested answers with `Yes, ...` and `No, ...`.
