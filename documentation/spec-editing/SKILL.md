---
name: spec-editing
description: Update the repository `spec/` tree as capability contracts that describe what the product must do, what boundaries it must respect, and how specs are organized.
---
...
Spec files are capability contracts. They describe the product behavior the system must eventually provide and the boundaries that behavior must obey.
